...
model_path = './best_model/TeCNO_CAT/'
model_name = 'TeCNO50_epoch_10'
...
model1_path = './best_model/TeCNO_t_CAT/'
model1_name = 'TeCNO50_trans1_3_5_1_length_30_epoch_2_train_8352_val_6812'
