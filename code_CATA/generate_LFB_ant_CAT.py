...
def train_model(train_dataset, train_num_each, val_dataset, val_num_each):
    ...
    if not load_exist_LFB:
        ...
        model_LFB.load_state_dict(torch.load("./best_model/emd_lr5e-4_ant_CAT/resnetfc_ce_epoch_15_length_1_opt_0_mulopt_1_flip_1_crop_1_batch_100_train_9944_val_6700_test_7483.pth"), strict=False)
        ...
        #'''
        with open("./LFB/g_LFB50_train_ant_CAT.pkl", 'wb') as f:
            pickle.dump(g_LFB_train, f)

        with open("./LFB/g_LFB50_val_ant_CAT.pkl", 'wb') as f:
            pickle.dump(g_LFB_val, f)
        #'''
        with open("./LFB/g_LFB50_test_ant_CAT.pkl", 'wb') as f:
...
def main():
    ...
    val_dataset, val_num_each, test_dataset, test_num_each = get_data('./train_val_paths_labels_CAT_ant.pkl')
