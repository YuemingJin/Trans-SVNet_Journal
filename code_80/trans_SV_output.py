...
train_labels_80, train_num_each_80, train_start_vidx,\
    ...
    test_labels_80, test_num_each_80, test_start_vidx, train_path80, val_path80, test_path80= get_data('./train_val_paths_labels1.pkl')      
...
model1_path = './best_model/TeCNO_t/'
model1_name = 'TeCNO50_trans1_3_5_1_length_30_epoch_0_train_8736_val_8889'
...
for epoch in range(max_epochs):
    ...
    with torch.no_grad():
        for i in val_we_use_start_idx_80:
            ...
            f = open(val_dir+'video'+path_s[7]+"-phase"+'.txt','w')
            # first_line = 1

            plot_phase_anticipation("./output/"+'video'+path_s[7]+"-pred"+".png",
    ...
    with torch.no_grad():
        for i in test_we_use_start_idx_80:
            ...
            path_s = path_whole.split('/')
            f = open(test_dir + 'video'+path_s[7]+"-phase" + '.txt', 'w')
